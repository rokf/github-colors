...
var _user$project$Messages$UpdateFilter = function (a) {
	return {ctor: 'UpdateFilter', _0: a};
};
var _user$project$Messages$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$Messages$HandleGetFile = function (a) {
	return {ctor: 'HandleGetFile', _0: a};
};
...
var _user$project$Model$initModel = {
	...
	all_text: '',
	filter: '',
	filtered_data: _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'Nothing', _1: '#ffffff'}
		])
};
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {data: a, all_text: b, filter: c, filtered_data: d};
	});

var _user$project$Helpers$get_name_from_tuple = function (inp) {
	var _p0 = inp;
	return _p0._0;
};
var _user$project$Helpers$filter_data = F2(
		...
		return A2(
			...
			function (el) {
				return A2(
					...
					_elm_lang$core$String$toLower(filter),
					_elm_lang$core$String$toLower(
						_user$project$Helpers$get_name_from_tuple(el)));
			},
			model.data);
	});

var _user$project$Parsers$raw_text = function (val) {
	var text = function () {
		var _p0 = val;
		if (_p0.ctor === 'Text') {
			return _p0._0;
...
var _user$project$Parsers$list2tuple2 = function (ls) {
	var _p1 = ls;
	if (_p1.ctor === '::') {
		if (_p1._1.ctor === '::') {
...
var _user$project$Parsers$submatch_parser = function (sm) {
	var _p2 = sm;
	if (_p2.ctor === 'Just') {
		return _p2._0;
	} else {
...
var _user$project$Parsers$submatch_splitter = function (m) {
	return _user$project$Parsers$list2tuple2(
		A2(
			_elm_lang$core$List$map,
			function (sm) {
				return _user$project$Parsers$submatch_parser(sm);
			},
			m.submatches));
};
var _user$project$Parsers$yaml_parser = function (val) {
	var text = function () {
		var _p3 = val;
		if (_p3.ctor === 'Text') {
			return _p3._0;
		} else {
			return 'yaml_parser : ERROR';
		}
	}();
	var all_matches = A3(
		_elm_lang$core$Regex$find,
		_elm_lang$core$Regex$All,
		_elm_lang$core$Regex$regex('([A-Z][\\w +#]*):(?:\\n  \\w+:[\\w\\s\\-\\.]+)+color: \"(#\\w+)\"'),
		text);
	var list_data = A2(_elm_lang$core$List$map, _user$project$Parsers$submatch_splitter, all_matches);
	var dmsg = A2(_elm_lang$core$Debug$log, 'list_data', list_data);
	return list_data;
};

var _user$project$Requests$get_file = function (model) {
	var req = {
		verb: 'GET',
		headers: _elm_lang$core$Native_List.fromArray(
			[]),
	...
	return A3(
		...
		_user$project$Messages$Error,
		_user$project$Messages$HandleGetFile,
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'UpdateFilter':
				var _p2 = _p0._0;
				var dmsg = A2(_elm_lang$core$Debug$log, 'filter', _p2);
				var filtered_data = A2(_user$project$Helpers$filter_data, model, _p2);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{filter: _p2, filtered_data: filtered_data}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			case 'NoOp':
				return A2(
...
var _user$project$View$pair_to_li = function (pair) {
	var _p0 = pair;
	var _p1 = _p0._1;
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('color-block'),
						_elm_lang$html$Html_Attributes$style(
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'background', _1: _p1}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
...
var _user$project$View$list_of_pairs = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (pair) {
			return _user$project$View$pair_to_li(pair);
		},
		model.filtered_data);
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onInput(_user$project$Messages$UpdateFilter),
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				_user$project$View$list_of_pairs(model))
			]));
};
...
var _user$project$Main$init = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_user$project$Requests$get_file(_user$project$Model$initModel)
		]));
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Main$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Subs$subscriptions})
};
